    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tema_estudio', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_tiempo_inicio', models.DateTimeField(blank=True, null=True)),
                ('shipping_tiempo_fin', models.DateTimeField(blank=True, null=True)),
                ('shipping_tema_estudio', models.CharField(blank=True, max_length=255, null=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
